...
# 2. Dynamic Model Logic (Prevents 404 Errors)
try:
    conn = st.connection("gsheets", type=GSheetsConnection, ttl=0)
    genai.configure(api_key=st.secrets["GEMINI_API_KEY"])
    
    # Dynamic Search for the best available model
...
if not st.session_state.messages:
    welcome = "Welcome to Duffley Law. I am an AI assistant, not an attorney, and this chat does not create an attorney-client relationship. How can we help you today?"
...
# 5. Reinstated Professional Footer
